...
public class CarController : MonoBehaviour
{
	...
	void FixedUpdate()
	{
		...
		{
			var drift_amount = Mathf.Lerp(drift_steering_speeed_min, drift_steering_speed_max, Mathf.InverseLerp(1, -1, steering.ReadValue<float>())) * drift_direction * drifting_value;
		...
		rb_speed_local = new UnityEngine.Vector2(rb_speed_right, rb_speed_forward); // recombines forward and right vectors
